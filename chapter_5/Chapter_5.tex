...
\caption{درخت دودویی حاصل از اجرای الگوریتم تبدیل درخت عمومی به درخت دودویی بر روی درخت شکل {\eqref{ch5:fig:threeAryTree}}}\label{ch5:fig:lcrsBinTree}
\end{center}
\end{figure}

تابع بازگشتی ایجاد درخت دودویی از روی درخت عمومی با استفاده از روش فرزند چپ - همنیای راست در قالب الگوریتم {\eqref{ch5:alg:cnvGen2Bin}} نشان داده شده است. درادامه روش کار این الگوریتم بیان خواهد شد.

\begin{algorithm}[H]
\caption{ایجاد درخت دودویی ار روی درخت عمومی به روش فرزند چپ - همنیای راست}\label{ch5:alg:cnvGen2Bin}
\begin{latin}
\begin{algorithmic}[1]
