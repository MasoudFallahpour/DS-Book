...
\captionsetup{labelformat=parens,labelfont={bf},margin=1cm,font=footnotesize}
...
\hypersetup{
	...
	citecolor=blue,
	linkcolor=blue,
	pdftitle={Mastering Data Structures},
	pdfauthor={Masood Fallahpoor},
	pdfkeywords={Computer Science}{Data structures}{Algorithms}
}

% Package for typsetting in Persian.
\usepackage{xepersian}

% Set the default font of Persian text.
\settextfont[Scale=1]{XB Niloofar}

% Reduce default size of Persian digits in math mode.
...
\algrenewcommand{\algorithmiccomment}[1]{\texttt{\textbf{/\hspace*{-0.3em}/}} #1}

% remove keyword "procedure" from procedure header
%\algrenewcommand\algorithmicprocedure{}
%
%% remove keyword "function" from function header
